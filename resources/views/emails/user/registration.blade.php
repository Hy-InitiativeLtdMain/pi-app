            ...
            <table style="padding: 0 15px" width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td align="center"
                        ...
                        <p style="line-height: 25px;color: #667585; font-weight: 500">Password : <b>{{$url[0]}}</b></p>
                ...
                <tr >
                    <td style="padding-bottom: 60px">
                        ...
                        <p style="line-height: 25px;color: #667585; font-weight: 500">
                            ...
                            We are happy you’re here. Your token is:.
                        </p>
                    </td>
                ...
                <tr>
                    <td align="center"
                        style="color: #979797; font-size: 16px; line-height: 25px;">
                        <p style="line-height: 25px;color: #667585; font-weight: 500">TOKEN :  {{$user->verifications()->latest()->first()->token}}</p>
                    </td>
                </tr>
                @endif
                <tr>
