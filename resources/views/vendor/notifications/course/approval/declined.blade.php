          ...
          <tbody style="position: relative">
            ...
            <tr>
              <td style="padding-bottom: 60px">
                <h3 style="margin-bottom: 0;color: #000000">Hello {{ $user['first_name'] . ' ' . $user['last_name'] }}
                </h3>
                <p style="line-height: 25px; color: #ff4d4f; font-weight: 500">
                  Unfortunately, your Course Lesson has been declined. <br>
                  <b>Course: </b>{{ $lesson->course->title }} <br>
                  <b>Lesson: </b>{{ $lesson->title }} <br>
                  Please review the feedback and make the necessary changes.
                  Login to WESOnline for more details.
                </p>
              </td>
            ...
            <tr>
              <td align="center" width="140" height="auto" style="padding: 50px 0 50px">
                <hr style="border-top: 5px solid #0056B0">
                <span>If you are having trouble, contact us at <a
                    href="mailto:info@wesonline.ng">info@wesonline.ng</a><br>
                </span>
            ...
            <tr>
              <td align="center" style="padding-bottom: 30px">
                <a href="#" role="button"
                  style="font-size:14px; font-weight:400;webkit-appearance: button;-moz-appearance: button;appearance: button;
