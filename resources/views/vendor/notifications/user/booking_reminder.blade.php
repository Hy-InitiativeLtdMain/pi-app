            ...
            <tr>
              <td style="padding-bottom: 60px">
                ...
                <p style="line-height: 25px;color: #667585; font-weight: 500">
                  This is a reminder for your upcoming booking. <br> <br>
                  <b>BOOKING DETAILS </b> <br>
                  <b>Mentor:</b> {{ $booking->mentor->firstname. ' '. $booking->mentor->lastname }} <br>
                  <b>Mentee:</b> {{ $booking->mentee->name }}<br>
                  <b>Date:</b> {{ $booking->date }} <br>
                  <b>Time:</b> {{ $booking->time }} <br>
                  <b>Reason:</b> {{ $booking->reason }} <br>
                  <b>Duration:</b> {{ $booking->mentorAvailability->duration }} <br>
